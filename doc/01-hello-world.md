...
まず、先ほど配置した`label1`コントロールをマウスでクリックし、図1-7のように選択された状態にします。次に「プロパティ」ウィンドウの`Text`プロパティを選択し、"label1"から"Hello World!"に変更してEnterキーを押します。すると、「フォーム デザイナ」での表示も"Hello World!"に変更されます（図1-8）。
